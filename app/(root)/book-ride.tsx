...
const BookRide = () => {
  ...
  const { drivers, selectedDriver, selectedPrice, selectedTime } =
    useDriverStore();
        ...
        <>
          ...
          <View className="flex flex-col w-full items-start justify-center py-3 px-5 rounded-3xl bg-general-600 mt-5">
            <View className="flex flex-row items-center justify-between w-full border-b border-white py-3">
              ...
              <Text className="text-lg font-JakartaMedium text-[#0CC25F]">
                ${selectedPrice}
              </Text>
            </View>
            ...
            <View className="flex flex-row items-center justify-between w-full border-b border-white py-3">
              ...
              <Text className="text-lg font-JakartaMedium">
                {formatTime(parseInt(`${selectedTime}`!)) || 5}
              </Text>
            </View>
          ...
          <View className="flex flex-col w-full items-start justify-center mt-5">
            <View className="flex flex-row items-center justify-start mt-3 border-t border-b border-general-700 w-full py-3">
              ...
              <Text className="text-[15px]  font-JakartaMedium ml-2">
                {userAddress}
              </Text>
            </View>
